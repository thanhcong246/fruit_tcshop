							...
							<form:form method="POST" action="#" novalidate="novalidate"
									...
									<div class="row">
										<div class="col-lg-6">
											...
											<img alt="" height="150px"
												src="<c:url value="/assets/uploads/news/${news.img }" />"
												onclick="openModal('<c:url value="/assets/uploads/news/${news.img }" />')">
										</div>
										<div class="col-lg-6">
								...
								<div class="form-group">
									...
									<textarea id="description" name="description"
										class="form-control" aria-required="true" aria-invalid="false">${news.description }</textarea>
								</div>
