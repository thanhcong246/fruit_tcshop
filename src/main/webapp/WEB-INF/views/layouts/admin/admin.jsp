...
<link rel="stylesheet"
	href='<c:url value="/assets/admin/assets/css/cs-skin-elastic.css" />'>
<link rel="stylesheet"
	href="<c:url value="/assets/admin/assets/css/style.css" />">
...
<body>
	<!-- left Dashboad -->
	<%@include file="/WEB-INF/views/layouts/admin/panel_dashboad.jsp"%>
	...
	<script
		src="<c:url value="/assets/admin/assets/js/init/weather-init.js" />"></script>
